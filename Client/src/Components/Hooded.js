...
export function Hooded(props) {
    const group = useRef();
    const { scene, materials, animations } = useGLTF("/Hooded Adventurer.glb");
    ...
    return (
        <group ref={group} {...props} dispose={null} position={position} scale={1.5} >
...
useGLTF.preload("/Hooded Adventurer.glb");
