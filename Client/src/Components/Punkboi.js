...
export function Punkboi(props) {
    const group = useRef();
    const { scene, materials, animations } = useGLTF("/Punkboi.glb");
    ...
    return (
        <group ref={group} {...props} position={position} scale={1.6}  dispose={null}>
